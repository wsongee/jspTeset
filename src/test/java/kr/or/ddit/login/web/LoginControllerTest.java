...
public class LoginControllerTest extends WebTestConfig {
	...
	public void processSuccessTest() throws Exception{
		mockMvc.perform(post("/login/process").contentType(MediaType.APPLICATION_FORM_URLENCODED) //컨트롤러에서 @body부분 타입때문
				.param("userid", "brown")
	...
	public void processFailTest() throws Exception{
		MvcResult result=	mockMvc.perform(post("/login/process").contentType(MediaType.APPLICATION_FORM_URLENCODED)
							.param("userid", "brown1111")
							.param("pass", "brownPassFaillllll")).andDo(print()).andReturn();

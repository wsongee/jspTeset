...
public class WebTestConfig {
	...
	//즉 sesrvice, repository 빈을 스캔하는 설정과 controller를 스캔하는 설정 두개가 필요
	...
	protected MockMvc mockMvc; //dispatcher servlet역할을 하는 객체
	/*
	...
	//view() : 스프링 프레임워크에 의해 요청이 처리되는 과정에서 발환된 viewName
	//model() : 컨트롤로에서 설정ㄷ한 속성값을 담는 객체
